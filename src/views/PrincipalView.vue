...
import ElementSocial from "../components/UI/ElementSocial.vue";

const misocial=reactive({
    cod:'fab',
    nombre: 'linkedin',
    ruta:'https://www.linkedin.com/in/cmedinasantamaria/'
})

const misocial1=reactive({
    cod:'fab',
    nombre: 'github',
